...
const meta: Meta<ActionCardRowComponent> = {
  ...
  decorators: [
    ...
    componentWrapperDecorator(
      (story) =>
        `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css"><div class="card-body" style="margin-top: 150px"> ${story} </div>`
    ),
  ],
};
